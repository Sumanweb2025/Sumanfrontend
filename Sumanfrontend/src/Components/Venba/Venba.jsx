      ...
      <div className="venba-page">
        ...
        <div className="venba-container">
          ...
          <div className="venba-page-content">
            ...
            {/* Main Content */}
            <div className="venba-main-content" ref={mainContentRef}>
                    ...
                    {currentProducts.map((product) => (
                      ...
                      >
                        <div className="venba-product-image-container">
                          ...
                          {(() => {
                            ...
                            if (hasOffer && activeOffer) {
                              return (
                                <div className="venba-offer-badge">
                          ...
                          <div className="venba-image-wrapper">
                            ...
                            <img
                              ...
                              alt={product.name}
                              className="venba-product-image primary-image"
                              onError={(e) => {
                            ...
                            {(
                              ...
                              (product.image && Array.isArray(product.image) && product.image.length > 1)
                                ...
                                <img
                                  ...
                                  className="venba-product-image secondary-image"
                                  onError={(e) => {
                        ...
                        <div className="venba-product-info">
                          ...
                          <div className="venba-product-price-section">{(() => {
                            const selectedIndex = getSelectedVariant(product);
                            const selectedVariant = product.variants[selectedIndex] || product.variants[0];
                            ...
                            if (hasOffer && activeOffer) {
                              ...
                              return (
                                <>
                                  <span className="price-text venba-discounted-price">${discountedPrice.toFixed(2)}</span>
                                  <span className="venba-original-price">${originalPrice.toFixed(2)}</span>
                                </>
                              );
                            }
                          ...
                          {product.hasMultipleVariants ? (
                              ...
                              {product.variants.map((variant, index) => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={`venba-gram-button ${isSelected ? 'selected' : ''} ${isOutOfStock ? 'out-of-stock' : ''}`}
                            ...
                            <div className="venba-single-gram">
                              <span className="venba-gram-display">{product.variants[0]?.gram || 'Standard'}</span>
                            </div>
                          )}
                          ...
                          {(() => {
                            ...
                            return stock > 0 ? (
                              ...
                              <button
                                className="venba-add-to-cart-btn sold-out-btn"
                                disabled
                              >
                                Sold Out
                              </button>
