                        ...
                        <div className="iyyapa-product-image-container">
                          ...
                          {(() => {
                            ...
                            if (hasOffer && activeOffer) {
                              return (
                                <div className="iyyapa-offer-badge">
                        ...
                        <div className="iyyapa-product-info">
                          ...
                          <div className="iyyapa-product-price-section">{(() => {
                            ...
                            if (hasOffer && activeOffer) {
                              ...
                              return (
                                <>
                                  <span className="price-text iyyapa-discounted-price">${discountedPrice.toFixed(2)}</span>
                                  <span className="iyyapa-original-price">${originalPrice.toFixed(2)}</span>
                                </>
                              );
                            }
