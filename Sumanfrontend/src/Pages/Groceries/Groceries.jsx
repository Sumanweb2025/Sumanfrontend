                    ...
                    {currentProducts.map((product) => (
                      ...
                      >
                        <div className="grocery-product-image-container">
                          ...
                          {(() => {
                            ...
                            if (hasOffer && activeOffer) {
                              return (
                                <div className="grocery-offer-badge">
                        ...
                        <div className="grocery-product-info">
                          ...
                          {/* <div className="grocery-product-price-section">{(() => {
                            const selectedIndex = getSelectedVariant(product);
                            const selectedVariant = product.variants[selectedIndex] || product.variants[0];
                            ...
                            if (hasOffer && activeOffer) {
                              ...
                              return (
                                <>
                                  <span className="price-text grocery-discounted-price">${discountedPrice.toFixed(2)}</span>
                                  <span className="grocery-original-price">${originalPrice.toFixed(2)}</span>
                                </>
                              );
                            }
