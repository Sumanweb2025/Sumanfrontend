    ...
    <>
      ...
      <div className="snacks-container">
        ...
        <div className="search-container">
          <input
            type="text"
            placeholder="Search snacks by name, brand or category..."
            value={searchTerm}
          ...
          <>
            <div className="snacks-grid">
              {currentProducts.map((product) => (
                <div key={product.product_id || product.id} className="snack-product-card">
                  ...
                  <div className="snack-product-details">
